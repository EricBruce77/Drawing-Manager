-- Fix search_drawings function - Drop and recreate cleanly
-- Run this in Supabase SQL Editor

-- Step 1: Drop any existing versions of the function
DROP FUNCTION IF EXISTS search_drawings(TEXT);
DROP FUNCTION IF EXISTS search_drawings(search_query TEXT);

-- Step 2: Create the function with correct return type
...
-- Step 4: Test the function with a simple query
SELECT * FROM search_drawings('test') LIMIT 5;
